...
# webhook settings
WEBHOOK_HOST = 'https://mrblack.alwaysdata.net/'
WEBHOOK_PATH = '/bot/'
...
client = pymongo.MongoClient(
    "mongodb+srv://boichukmykhailo:qwerty12345@cluster0.qeiyage.mongodb.net/?retryWrites=true&w=majority")
db = client.get_database("BotDB")
